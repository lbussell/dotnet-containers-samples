...
class Build
{
    ...
    private readonly SampleDefinition[] _samples = [
        ...
        new(ParentDirectory: SamplesDir, TemplateName: "container-console", Name: "ConsoleAppSelfContainedDistroless", PublishType.SelfContained,      Distroless: true,   Globalization: false, Description: "Self-contained distroless console app"),

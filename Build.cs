...
class Build
{
    ...
    private readonly IEnumerable<SampleDefinition> _webSamples = [
        new(ParentDirectory: SamplesDir, TemplateName: WebApiTemplate, Name: "WebApi", PublishType.FrameworkDependent, Distroless: false, Globalization: false, Description: "Framework-dependent web app"),
    ];
